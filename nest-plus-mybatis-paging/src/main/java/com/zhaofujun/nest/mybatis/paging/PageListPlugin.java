package com.zhaofujun.nest.mybatis.paging;
...
//        BoundSql boundSql = mappedStatement.getBoundSql(page);
        ...
        try {
            ...
            if (metaParamsField != null) {
                setValueByFieldName(countBoundSql, "metaParameters", getValueByFieldName(boundSql, "metaParameters"));
            }
            Field additionalParamsField = getFieldByFieldName(boundSql, "additionalParameters");
            if (additionalParamsField != null) {
                setValueByFieldName(countBoundSql, "additionalParameters", getValueByFieldName(boundSql, "additionalParameters"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
